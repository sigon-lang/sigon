...
contract = {
       ...
       "jobDescription": ["qa", "programmer", "teamManager", "projectManager"], # Responsibilities given to the employer. The possible values are (a) QA, (b) Programmer, (c) Team Manager, or (d) Project Manager;
       "carBenefits": ["yes", "no", "noAgreement"], # (a) providing a leased company car, (b) no leased car, or (c) no agreement;
       "pensionBenefits": ["0", "10", "20", "noAgreement"], # Pension benefits: The possible value for the percentage of the salary deposited in pension funds are (a) 0\%, (b) 10\%, (c) 20\%, or (d) no agreement;
       "promotionPossibilities": ["2", "4", "noAgreement"], # The possible values are (a) fast promotion track (2 years), (b) slow promotion track (4 years), or (c) no agreement;
...
read_sensor.perceive(json.dumps(contract))
